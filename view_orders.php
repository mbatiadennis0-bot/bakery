...
<head>
    ...
    <style>
        ...
        .container { max-width: 1100px; margin: auto; background: rgba(255, 250, 245, 0.94); padding: 30px; border-radius: 24px; box-shadow: 0 5px 20px rgba(0,0,0,0.05); border: 1px solid rgba(255,255,255,0.2); backdrop-filter: blur(8px); }
        ...
        .search-box { padding: 10px; border: 1px solid #ddd; border-radius: 8px; width: 250px; font-family: inherit; background: rgba(255,255,255,0.92); }
    </style>
</head>
<body>
    <div class="container">
