...
<head>
    ...
    <style>
        ...
        .item-card { background: white; padding: 20px; border-radius: 15px; text-align: center; box-shadow: 0 4px 10px rgba(0,0,0,0.05); border: 1px solid transparent; transition: 0.3s; }
        ...
        /* Cart Sidebar */
        .cart-section { flex: 1; background: white; padding: 25px; border-radius: 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); height: fit-content; position: sticky; top: 20px; }
...
<body>
    ...
    <div class="main-container">
        <div class="products-section">
            ...
            <div class="grid">
                <?php
                // Note: Ensure your column is 'stock_level' per your description
    ...
    <script>
        ...
        // UPDATED: Now accepts 'id' as the first parameter
        function addToCart(id, name, price) {
            const existingItem = cart.find(item => item.id === id);
            if (existingItem) {
                existingItem.qty++;
            } else {
                // Now storing the ID so process_order.php can find it
        ...
        function updateCartUI() {
            ...
            // This now includes the 'id' field that was missing
