<?php
// 1. Database and Navbar (Navbar handles session_start)
include 'db.php'; 
include 'navbar.php'; 

// 2. STRICT SECURITY: Only 'dayknow' can see this page
if (!isset($_SESSION['username']) || $_SESSION['username'] !== 'dayknow') {
    echo "<script>alert('Access Denied: Admin Only Area'); window.location='dashboard.php';</script>";
    exit();
}
...
<head>
    ...
    <style>
        ...
        .stat-card { 
            ...
            border-bottom: 6px solid var(--accent); transition: 0.3s; 
        }
        ...
        .card-panel { background: white; padding: 25px; border-radius: 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.05); }
